            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" placeholder="Name" id="title" name="title" class="form-control <?php echo (isset($validation) && $validation->hasError('title')) ? 'is-invalid':''; ?>" value="<?php echo set_value('title',$book['title']); ?>">
                        <?php
                    ...
                    <div class="form-group">
                        <label>Author</label>
                        <input type="text" placeholder="Author" id="author" name="author" class="form-control <?php echo (isset($validation) && $validation->hasError('author')) ? 'is-invalid':''; ?>" value="<?php echo set_value('author',$book['author']); ?>">
                        <?php
                    ...
                    <div class="form-group">
                        <label>ISBN</label>
                        <input type="text" placeholder="ISBN no." id="isbn_no" name="isbn_no" class="form-control <?php echo (isset($validation) && $validation->hasError('isbn_no'))?'is-invalid':''; ?>" value="<?php echo set_value('isbn_no',$book['isbn_no']); ?>">
                        <?php
